...
urlpatterns = [
    ...
    url('(?P<project_id>[0-9]+)/time-review$', ProjectDashboardPostedTimeReview.as_view(), name='pdash-time-review'),
    url('(?P<project_id>[0-9]+)/time-review/(?P<pk>[0-9]+)$', ProjectDashboardPostedTimeReview.as_view(), name='pdash-time-review'),
    url('(?P<project_id>[0-9]+)/time-review/(?P<pk>[0-9]+)/(?P<mode>edit|delete)$', ProjectDashboardPostedTimeReview.as_view(), name='pdash-time-review'),
